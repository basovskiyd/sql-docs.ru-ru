...
|Collation|Имя параметров сортировки для сервера, установленного по умолчанию.<br /><br /> NULL = недопустимый ввод или произошла ошибка.<br /><br /> Базовый тип данных: **nvarchar(128)**|  
